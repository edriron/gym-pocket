  ...
  return (
    <aside className="hidden md:flex h-screen w-64 flex-col border-r bg-card px-3 py-5 gap-1 sticky top-0">
      ...
      <div className="flex items-center gap-3 px-3 pb-5">
        <div className="flex size-9 items-center justify-center rounded-xl bg-linear-to-br from-indigo-500 to-violet-600 shadow-sm shrink-0">
          <Image src="/icon.png" alt="Gym Pocket" width={22} height={22} />
        </div>
        <div className="min-w-0">
          <span className="font-bold text-[15px] leading-tight block">Gym Pocket</span>
          <span className="text-[11px] text-muted-foreground leading-tight">Fitness Tracker</span>
        </div>
      </div>
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : cn('text-muted-foreground font-medium', accent.bgIdle, 'hover:text-foreground')
              )}
            >
              <span
                className={cn(
